...
class AVH_FDAS_IPCacheList extends WP_List_Table
{
	...
	function prepare_items ()
	{
		...
		$args = array ( 'status' => $ip_status, 'search' => $search, 'offset' => $start, 'number' => $number, 'orderby' => $orderby, 
						'order' => $order );
	...
	function get_columns ()
	{
		...
		return array ( 'cb' => '<input type="checkbox" />', 'ip' => __('IP'), 'spam' => __('Ham/Spam', 'avh-fdas'), 
					'added' => __('Date added', 'avh-fdas'), 'lastseen' => __('Last seen', 'avh-fdas') );
	}
